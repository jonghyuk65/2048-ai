...
if __name__ == '__main__':
    ...
    testAgent(100, ntuple_light(filename = 'models/vl_light_0611145326_60000'))
    #testAgent(100, ntuple(filename = 'models/vl_0518110412_50000', depth = 2))
    testAgent(100, ntuple_light(filename = 'models/vl_light_0611145326_60000', depth = 2, show_arg = False))
